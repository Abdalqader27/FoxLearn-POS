...
class _$_Unit implements _Unit {
  ...
  @override
  String toString() {
    return 'Unit(id: $id, name: $name, isActivated: $isActivated, publishTime: $publishTime, lessonsCount: $lessonsCount, subjectId: $subjectId, subjectName: $subjectName, teacherName: $teacherName, price: $price)';
  }
